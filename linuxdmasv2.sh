...
# ==========================================
# LAUNCHER startdmas.sh (có menu thoát/restart)
# ==========================================
...
echo "Se xoa: container, termux-x11-nightly, launcher, flag, log."
printf 'Nhap dung chu "yes" de xac nhan: '
read -r CONF
if [ "$CONF" != "yes" ]; then echo "Huy lenh go."; exit 1; fi
echo "[*] Dung X11..."
